    ...
    <div class="card bg-white text-dark">
        ...
        <form action="{{url('/add_signup')}}" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" value="{{old('mobile')}}" class="form-control" name="mobile" placeholder="Enter mobile number">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" value="{{old('pass')}}" class="form-control" name="pass" placeholder="Enter password">
            </div>
